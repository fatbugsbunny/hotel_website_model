	...
	return (
		<div className={`relative h-[90vh]`}>
			...
			<div className={`absolute top-1/2 left-1/2 w-full -translate-1/2 text-center ${montserrat.className} text-gray-200`}>
				<p className={`py-1 text-[1.05rem] sm:text-[1.3rem]`}>Welcome To</p>
				<p className={`py-1 text-5xl sm:text-7xl`}>HOTEL NAME</p>
				<p className={`py-1 text-[1.05rem] sm:text-[1.4rem]`}>Memories That Last Forever</p>
