...
export default function Facility({
	...
	return (
		<div className={`${switchColor ? "bg-primary text-tertiary" : "bg-tertiary text-primary"} mx-10 grid w-full grid-cols-1 items-center p-2 transition duration-250 hover:-translate-y-1/16 hover:shadow-xl`}>
